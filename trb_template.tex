...
% Call the trb class file, at the moment customization possible only inside the
% cls file
\documentclass{trb_unofficial}

% Change to the last names of the authors, use et al. if 4+ authors
...
% TODO: when not in draft mode it should not appear. Set it in cls file
% comment out for final manuscript to remove the numbering
\pagewiselinenumbers%

\begin{titlepage}
\begin{flushleft}

% TODO: move to cls file and wrap it in maketitle
% Title
