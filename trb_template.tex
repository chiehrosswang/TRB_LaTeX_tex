...
% Add authors using \TRBauthor{Name}{Affiliation}{Email}[ORCID]
\TRBauthor{David Pritchard}{davidpritchard.org}{davidpritchard@fake.email}
\TRBauthor{Gregory S. Macfarlane, Ph.D.}{gregmacfarlane.github.io}{gregsmacfarlane@fake.email}[]
\TRBauthor*{Chieh (Ross) Wang}{Oak Ridge National Laboratory}{cwang@ornl.gov}[0000-0001-8073-7683]
